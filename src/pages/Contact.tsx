...
const Contact: React.FC = () => {
  ...
  const handleFormSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // If Supabase is configured, use it; otherwise fall back to mailto
  ...
  // Primary: main channels (larger, vibrant). Secondary: smaller sub-grid (design-social.md)
  const socialPrimary = [
    ...
    <div className="relative flex flex-col flex-1 min-h-screen">
      <main className="relative z-10 flex-grow container mx-auto px-4 pt-4 pb-16">
        <div className="max-w-6xl mx-auto">
                ...
                {showSuccessOverlay && (
                  ...
                  >
                    ...
                    >
                      ...
                      <p className="text-alien-gold font-exo text-lg">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className={`bg-alien-space-dark/60 border-2 transition-all text-white placeholder:text-gray-300 ${
                      focusedField === 'name' 
                        ? 'border-alien-green shadow-[0_0_15px_rgba(57,255,20,0.4)]' 
                        : formErrors.name
                  ...
                  {formErrors.name && (
                    ...
                    >
                      <span className="text-red-500">⚠</span> {formErrors.name}
                    </motion.p>
                  )}
                </div>
                <div className="space-y-2">
                  ...
                  {formErrors.email && (
                    <motion.p 
                      ...
                      className="text-red-400 text-sm flex items-center gap-1"
                    >
                      <span className="text-red-500">⚠</span> {formErrors.email}
                    </motion.p>
                  )}
                </div>
          ...
          {/* Quick Support & Social Links — FBM: Motivation, Ability, Prompt (design-social.md) */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
            {/* Quick Support Cards — condensed layout, scanline glow, Copy email, View Roadmap */}
            <motion.div
            ...
            >
              ...
              <div 
                className="relative p-4 bg-gradient-to-br from-green-500/20 to-green-600/10 border border-green-500/40 rounded-xl hover:border-green-500/60 hover:shadow-[0_0_20px_rgba(34,197,94,0.3)] transition-all duration-300 group overflow-hidden"
              >
                <div className="absolute inset-0 bg-gradient-to-b from-white/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none" aria-hidden />
                <div className="flex items-center gap-2 mb-1 relative">
                ...
                <div className="flex items-center gap-2">
                  ...
                  >
                    {emailCopied ? (
                      <span className="text-[10px] font-exo">✓</span>
                    ) : (
            ...
            {/* Social — "Join the Transmission" CTA; primary vs secondary; Coming Soon pulse + Notify me */}
            <motion.div
              initial={{ opacity: 0, x: 20 }}
              animate={{ opacity: 1, x: 0 }}
            ...
            >
              ...
              <div className="space-y-4">
                {/* Primary: larger, vibrant — min 44px touch targets */}
